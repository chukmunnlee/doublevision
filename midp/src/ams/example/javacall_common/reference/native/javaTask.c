...
int main(void) {
    ...
    argv[0] = "runMidlet";
    argv[1] = "internal";
    argv[0] = "com.sun.midp.demos.HelloWorld";
    javacall_print("Start Java Task\n");	
    midpInitializeMemory(-1) ;
    JVM_Initialize();
    javacall_print("JVM_initialize\n");	

    JVM_ParseOneArg(argc, argv);
  
    javacall_print("Start JVM\n");	
    JVM_Start(NULL, NULL, argc, argv);
    javacall_print("End JVM\n");	
    midpFinalizeMemory();
}
#endif
